...
object MealMockUtils {
    ...
    fun getMockMeals(): List<MealModel> {
        ...
        for (i in 1..50) {
            mealList.add(
                MealModel(
                    ...
                    imageUrl = "https://www.themealdb.com/images/media/meals/sytuqu15115",
                    ingredients = listOf("Ingredient $i", "Ingredient $i"),
                    measurements = listOf("Measurement $i", "Measurement $i"),
                    instructions = "Instructions $i",
                    youtubeUrl = "https://www.youtube.com/watch?v=",
                    category = "Category $i",
                    area = "Area $i",
                    tags = listOf("Tag $i", "Tag $i"),
    ...
    fun getMealNetworkResponse(): MealsResponse {
        val gson = Gson()
        val response = gson.fromJson<MealsResponse>(mockResponse, MealsResponse::class.java)
        return response
    }

    fun getMealDetailsResponse(mealId: String): List<MealModel>  {
        return getMockMeals().filter {
            it.id  == mealId
        }
    }
